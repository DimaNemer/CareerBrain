            ...
            <aside className="relative overflow-hidden bg-gradient-to-br from-indigo-950 via-indigo-900 to-slate-900 p-8 text-white sm:p-10">
              ...
              <div className="relative">
                ...
                <h1 className="mt-6 text-3xl font-bold tracking-tight">
                  Keep your project clear and current.
                </h1>
                <p className="mt-3 text-sm leading-6 text-indigo-100/75">
                  Good project details help the right collaborators understand
                  the vision and where the team is heading.
                </p>
                ...
                <div className="mt-10 space-y-5">
                  {[
                    {
                      icon: FileText,
                      title: 'Refine the description',
                      text: 'Keep the goals and expected outcome easy to understand.',
                    },
                    {
                      icon: RefreshCw,
                      title: 'Keep status accurate',
                      text: 'Let people know whether the project is recruiting or underway.',
                    },
                    {
                      icon: CheckCircle2,
                      title: 'Save with confidence',
                      text: 'Your roles, members, and requests remain unchanged.',
                    },
            ...
            <section className="p-6 sm:p-10">
              <div className="mb-7">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Make changes below, then save when you are ready.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      rows="6"
                      className="w-full resize-none rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-4 text-sm leading-6 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-4 focus:ring-indigo-100"
                    />
                  </div>
                </div>
